  ...
  describe '#generate_suggestion_queries' do
    ...
    context 'with email and no seed' do
      it 'returns the body for a query for two document categories - Journal Document and Conference Proceeding Document' do
        ...
        query_bod2 = "<?xml version='1.0'?>\n      <PublicationAuthorMatchParameters xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:xsd='http://www.w3.org/2001/XMLSchema'>\n        <Authors>\n          <Author>\n            <LastName>Smith</LastName>\n            <FirstName>Jane</FirstName>\n            <MiddleName></MiddleName>\n            <Address1></Address1>\n            <City>Stanford</City>\n            <State>CA</State>\n            <Country>USA</Country>\n            <Version>1</Version>\n         </Author>\n      </Authors>\n      <DocumentCategory>Conference Proceeding Document</DocumentCategory>\n      <Emails>\n                  <string>jane_smith@example.com</string>\n                </Emails><LimitToHighQualityMatchesOnly>true</LimitToHighQualityMatchesOnly></PublicationAuthorMatchParameters>"
        expect { |b| sw_client.generate_suggestion_queries('Smith', 'Jane', '', "jane_smith@example.com", '', '', &b) }.to yield_successive_args(query_bod1, query_bod2)
      end
    end
    context 'with no email and no seed' do
      it 'returns the body for a query for two document categories - Journal Document and Conference Proceeding Document' do
        query_bod1 = "<?xml version='1.0'?>\n      <PublicationAuthorMatchParameters xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:xsd='http://www.w3.org/2001/XMLSchema'>\n        <Authors>\n          <Author>\n            <LastName>Brown</LastName>\n            <FirstName>Charlie</FirstName>\n            <MiddleName></MiddleName>\n            <Address1>Special Tech</Address1>\n            <City>Stanford</City>\n            <State>CA</State>\n            <Country>USA</Country>\n            <Version>1</Version>\n         </Author>\n      </Authors>\n      <DocumentCategory>Journal Document</DocumentCategory>\n      <LimitToHighQualityMatchesOnly>true</LimitToHighQualityMatchesOnly></PublicationAuthorMatchParameters>"
        query_bod2 = "<?xml version='1.0'?>\n      <PublicationAuthorMatchParameters xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:xsd='http://www.w3.org/2001/XMLSchema'>\n        <Authors>\n          <Author>\n            <LastName>Brown</LastName>\n            <FirstName>Charlie</FirstName>\n            <MiddleName></MiddleName>\n            <Address1>Special Tech</Address1>\n            <City>Stanford</City>\n            <State>CA</State>\n            <Country>USA</Country>\n            <Version>1</Version>\n         </Author>\n      </Authors>\n      <DocumentCategory>Conference Proceeding Document</DocumentCategory>\n      <LimitToHighQualityMatchesOnly>true</LimitToHighQualityMatchesOnly></PublicationAuthorMatchParameters>"
        expect { |b| sw_client.generate_suggestion_queries('Brown', 'Charlie', '', '', 'Special Tech', '', &b) }.to yield_successive_args(query_bod1, query_bod2)
      end
    end
  end
end
