  ...
  class AuthorshipAPI < Grape::API
    ...
    post do
      ...
      sul_pub = if params[:publication][:id]
                  ...
                  error!("The pmid you've specified can't be found either locally or at PubMed.", 400) if p.nil?
                  p
                elsif params[:publication][:sciencewire_id]
                  p = Publication.find_or_create_by_sciencewire_id(params[:publication][:sciencewire_id])
                  error!("The ScienceWire publication you've specified can't be found either locally or at ScienceWire.", 400) if p.nil?
                  p
                else
