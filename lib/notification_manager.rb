class NotificationManager
  ...
  class << self
    ...
    def error(e, message, callee = nil)
      ...
      when WebOfScience::Record, WebOfScience::Records, WebOfScience::Identifiers,
        WebOfScience::ProcessRecords, WebOfScience::ProcessRecord,
        WebOfScience::Harvester, WebOfScience::Client
